                ...
                dbc.Col(
                    ...
                    html.Div(
                        [   html.Br([]),
                            ...
                            html.P(
                                "\
                            Nous vous présentons ici les données sur les abeilles de New York U.S Department. Nous examinerons ce qui affectent les\
                                abeilles, soit les maladies , soit les pesticides, les pourcentages de colonies qui sont affectées par les maladies etc.",
